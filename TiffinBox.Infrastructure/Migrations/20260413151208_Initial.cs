        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaxDailyOrders = table.Column<int>(type: "int", nullable: false),
                    CurrentDailyOrders = table.Column<int>(type: "int", nullable: false),
                    ...
                    DeliveryFeeId = table.Column<int>(type: "int", nullable: true),
                    MinOrderAmountId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Vendors_Address_BusinessAddressId",
                        column: x => x.BusinessAddressId,
                        principalTable: "Address",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Vendors_GeoLocation_LocationId",
                        column: x => x.LocationId,
                        principalTable: "GeoLocation",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Vendors_Money_DeliveryFeeId",
                        column: x => x.DeliveryFeeId,
                        principalTable: "Money",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Vendors_Money_MinOrderAmountId",
                        column: x => x.MinOrderAmountId,
                        principalTable: "Money",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DeliveryAgents_GeoLocation_CurrentLocationId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_DeliveryAgents_Vendors_VendorId",
                        column: x => x.VendorId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MenuItems_Money_PriceId",
                        column: x => x.PriceId,
                        principalTable: "Money",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsActive = table.Column<bool>(type: "bit", nullable: false, defaultValue: true),
                    MaxSubscribers = table.Column<int>(type: "int", nullable: false, defaultValue: 50),
                    CurrentSubscribers = table.Column<int>(type: "int", nullable: false, defaultValue: 0),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SubscriptionPlans_Vendors_VendorId",
                        column: x => x.VendorId,
                        principalTable: "Vendors",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeliveredDays = table.Column<int>(type: "int", nullable: false, defaultValue: 0),
                    SkippedDays = table.Column<int>(type: "int", nullable: false, defaultValue: 0),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    RowVersion = table.Column<byte[]>(type: "varbinary(max)", nullable: false)
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Orders_Money_TotalAmountId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SubscriptionMeals", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SubscriptionMeals_MenuItems_MenuItemId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DeliveryAgents_CurrentLocationId",
                table: "DeliveryAgents",
                column: "CurrentLocationId");

            migrationBuilder.CreateIndex(
                name: "IX_DeliveryAgents_IsActive",
                table: "DeliveryAgents",
                column: "IsActive");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DeliveryAgents_VendorId",
                table: "DeliveryAgents",
                column: "VendorId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SubscriptionMeals_MenuItemId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SubscriptionPlans_VendorId",
                table: "SubscriptionPlans",
                column: "VendorId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Subscriptions_CustomerId_VendorId_Status",
                table: "Subscriptions",
                columns: new[] { "CustomerId", "VendorId", "Status" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Vendors_MinOrderAmountId",
                table: "Vendors",
                column: "MinOrderAmountId");
